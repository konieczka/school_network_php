...
$result = pg_query($db_connection, 'SELECT * FROM teachers');
$allTeachers = pg_fetch_all($result);
...
<head>
    ...
    <title>School Network - Teachers</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div style="margin-left:25px; margin-right:25px">
                <?php
                // Display informative prompts about result of the executed operation.
                if ($messagePrompt == 0) {
                    ...
                    echo
                        '<div class="alert alert-success" role="alert">
                            Teacher added to the database.
                        </div>';
                } else if ($messagePrompt == 2) {
                    echo '<div class="alert alert-info" role="alert">
                            Teacher data edited successfully.
                        </div>';
                } else if ($messagePrompt == 4) {
                    echo '<div class="alert alert-info" role="alert">
                            Teacher deleted from the database.
                         </div>';
                };
                ...
                <table class="table table-striped">
                    ...
                    for ($i = 0; $i < count($allTeachers); $i++) {
                        ...
                        echo "<tr><td>$i</td><td>" . $teacher['first_name'] .
                            "</td><td>" . $teacher['last_name'] .
                            "</td><td>" . $teacher['date_of_birth']  .
                            "</td>";
                ...
                <!-- Button triggering new teacher form modal -->
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newTeacherModal">
                    New teacher
                </button>
                <!-- /#wrapper -->
                ...
                <!-- Modal containing new teacher form -->
                <div class="modal fade" id="newTeacherModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <form action="newteacher.php" method="post">
                            <div class="modal-content" style="width: 50vw">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalCenterTitle">Add new teacher</h5>
            ...
            <!-- Modal containing edit teacher form -->
            <div class="modal fade" id="editTeacherModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <form action="editteacher.php" method="post">
                        <div class="modal-content" style="width: 50vw">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Edit teacher</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
        ...
        <script>
            function getTeacher(id, first_name, last_name, birthdate) {
                console.log("CLICK! ", first_name, id);
